...
oauth.revokeAccessToken = function(req, res) {
	console.log('Access Token in revokeAccessToken: ' + res.access_token);
	connection.getOrg().revokeToken({req.session.accesstoken},function(req, res, app){oauth.redirectToHome(req, res, app);});
}
